...
public class PrinterManager {
	...
	// 0：普通文字； 1：Bitmap 图片 2：单行虚线 3：空行 4：左右对齐文字 5：条形码 6：二维码

	public static final int PRINT_CONTENT_TYPE_TEXT = 0;
	public static final int PRINT_CONTENT_TYPE_BITMAP = 1;
	public static final int PRINT_CONTENT_TYPE_DASH_LINE = 2;
	public static final int PRINT_CONTENT_TYPE_BLANK_LINE = 3;
	public static final int PRINT_CONTENT_TYPE_MULTI_TEXT = 4;
	public static final int PRINT_CONTENT_TYPE_BAR_CODE = 5;
	public static final int PRINT_CONTENT_TYPE_QR_CODE = 6;
}
