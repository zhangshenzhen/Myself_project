...
import com.shenzhen.scrollview_inner_slide.pulltorefresh.PullToRefreshBase;
import com.shenzhen.scrollview_inner_slide.pulltorefresh.PullToRefreshScrollView;
...
public class SecondActivity extends AppCompatActivity implements View.OnClickListener,ActivityCompat.OnRequestPermissionsResultCallback {
    ...
    private PullToRefreshScrollView Pull_swipe_layout;
    ...
    * */
    ...
    private void initView() {
        ...
        Pull_swipe_layout = findViewById(R.id.Pull_swipe_layout);
        Pull_swipe_layout.getLoadingLayoutProxy().setLastUpdatedLabel("lastUpdateLabel");
        Pull_swipe_layout.getLoadingLayoutProxy().setPullLabel("PULLLABLE");
        Pull_swipe_layout.getLoadingLayoutProxy().setRefreshingLabel("refreshingLabel");
        Pull_swipe_layout.getLoadingLayoutProxy().setReleaseLabel("releaseLabel");
        //上拉、下拉设定
        Pull_swipe_layout.setMode(PullToRefreshBase.Mode.PULL_FROM_START);
    ...
    * */
    ...
    private void initData() {
        ...
        /*
         * ViewPager*/
        vp.setAdapter(new BannerPager(SecondActivity.this, viewpagerpicture));
        vp.setCurrentItem(0);
      ...
      /* try {
        ...
        /*纵向listView*/
        /*添加叫布局*/
        View view = LayoutInflater.from(SecondActivity.this).inflate(R.layout.foot, null);
    ...
    private void initListener() {
       /* *//*SwipeLayout*//*
        ...
        Pull_swipe_layout.setOnRefreshListener(new PullToRefreshBase.OnRefreshListener2<ScrollView>() {
            @Override
    ...
    private void test() {
        ...
        testCaculate.caculate(SecondActivity.this);
