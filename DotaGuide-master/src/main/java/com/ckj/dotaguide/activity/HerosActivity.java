                ...
                .subscribe(new Subscriber<ResponseBody>() {
                    ...
                    public void onNext(ResponseBody responseBody) {
                        try {
                            ...
                            System.out.println("数据bodyElement ："+bodyElement);
                            Element powerElement = bodyElement.getElementsByClass("cl con picbox").get(type);
                            System.out.println("数据powerElement ："+powerElement);
                            Elements links = powerElement.getElementsByTag("li"); //得到基本对象集合
                            System.out.println("数据links ："+links);
