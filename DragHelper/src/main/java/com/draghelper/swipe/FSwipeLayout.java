...
public class FSwipeLayout extends FrameLayout {
    ...
    //重写三个构造方法
    public FSwipeLayout(Context context) {
        this(context, null);
    }

    public FSwipeLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public FSwipeLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if(preStatus!=status&&swipeChangeListener!=null){
            if(status==Status.CLOSE){
                ...
                if(preStatus==Status.CLOSE){
                    ...
                    swipeChangeListener.onStartClose(FSwipeLayout.this);
                }
            }
        }
    }
...
//		bringChildToFront(frontView);
    ...
    public static interface OnSwipeChangeListener {
        void onDraging(FSwipeLayout mSwipeLayout);

        void onOpen(FSwipeLayout mSwipeLayout);

        void onClose(FSwipeLayout mSwipeLayout);

        void onStartOpen(FSwipeLayout mSwipeLayout);

        void onStartClose(FSwipeLayout mSwipeLayout);
