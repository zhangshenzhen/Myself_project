...
public abstract class CommonAdapter<T> extends Adapter<FlowViewHolder> {
    ...
    public FlowViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        FlowViewHolder viewHolder = FlowViewHolder.get(this.mContext, (View)null, parent, this.mLayoutId);
        if (null == this.mRv) {
            this.mRv = parent;
        }
    ...
    /** @deprecated */
    @Deprecated
    protected void setListener(final ViewGroup parent, final FlowViewHolder viewHolder, int viewType) {
    ...
    protected void setListener(final int position, final FlowViewHolder viewHolder) {
    ...
    public abstract void convert(FlowViewHolder var1, T var2);
